...
function canvasApp() {
	...
	// Adjust these values for the blue glow
	var sphereRad = 140;
	var radius_sp = 1;
	var particleRad = 1.8;
	
	// Update particle color to match the image
	var r = 0;
	var g = 149;
	var b = 255;

	// Add glow effect
	context.shadowColor = 'rgba(0, 149, 255, 0.5)';
	...
	function init() {
		...
		turnSpeed = 2 * Math.PI / 800; //increased rotation speed (was 1200)
	...
	function onTimer() {
		...
		//background fill - make it transparent
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    class Particle {
        ...
        draw() {
            ...
            ctx.fillStyle = `rgba(0, 149, 255, ${this.alpha})`;
            ctx.fill();
        }
    }
